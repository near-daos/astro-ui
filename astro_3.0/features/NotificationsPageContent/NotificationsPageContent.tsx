...
import { useNotificationsListOpenSearch } from 'astro_2.0/features/Notifications/hooks';
import { useTranslation } from 'next-i18next';
import styles from 'pages/notifications/NotificationsPage.module.scss';
...
export const NotificationsPageContent: FC<Props> = ({ config }) => {
  ...
  const {
    ...
    handleUpdate,
    handleRemove,
  } = useNotificationsListOpenSearch();
